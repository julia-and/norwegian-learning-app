...
import { LayoutDashboard, BarChart3, BookOpen, Settings, Flame, Sun, Moon, Globe, PenLine, BookMarked, MessageSquare, ArrowLeftRight, Newspaper } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { href: '/feed', label: 'Lesefeed', icon: Newspaper },
